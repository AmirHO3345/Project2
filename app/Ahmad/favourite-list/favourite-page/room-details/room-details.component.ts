...
constructor(private Render : Renderer2,private roomSer:RoomServiceComponent,
  private route:ActivatedRoute,private listfav:ListfavsComponent,private router:Router) {
...
staticPath='http://127.0.0.1:8000/';
  ...
  ngOnInit() {
    ...
    (params:Params)=>{
      ...
      this.roomSer.setIdFav(this.id);
      //this.search.tag=true;
      this.listfav.check=true;
